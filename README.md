...
|-------------|--------------|----------------|
| [🛰️ **SOC-Incident-Reports**](https://github.com/PurePootato/SOC-Incident-Reports) | Real-world style SOC case studies — log triage, MITRE ATT&CK mapping, and containment actions. | `QRadar`, `Splunk`, `Suricata`, `CrowdStrike`, `MITRE ATT&CK` |
